...
export function ShareDialog({ url, title, description, open, onOpenChange }: ShareDialogProps) {
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      action: async () => {
        ...
        toast.success(i18n.language === 'sw' 
          ? 'Kiungo kimenakiliwa! Bandika kwenye Instagram' 
    ...
    },
    {
      ...
      action: async () => {
        await navigator.clipboard.writeText(`${shareText}\n${url}`);
        toast.success(i18n.language === 'sw' 
          ? 'Kiungo kimenakiliwa! Bandika kwenye TikTok' 
          : 'Link copied! Paste it on TikTok');
      },
    },
    {
      name: 'SMS',
